...
import com.mobidroid.nanodegree.moviefinder.settings.SettingsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.container_movies) != null) {
            ...
            if (savedInstanceState == null) {
                ...
                mFragment = (MovieListFragment) getSupportFragmentManager()
    ...
    protected void onResume() {
        ...
        if(sortOrder != null && !sortOrder.equals(mSortOrder)) {
            if ( null != mFragment ) {
                ...
                mFragment = (MovieListFragment) getSupportFragmentManager().findFragmentById(R.id.fragment);
                mFragment.setTwoPane(mTwoPane);
                mFragment.onSortOrderChanged();
            }
